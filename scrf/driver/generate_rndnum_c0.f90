...
! the correlation is cij = c0 * exp(-dij/clen)
 ...
 & stat=ierr)
  ...
  do mm = 1, 12
	  ...
	  if (.NOT. file_exists) then
		  ...
		  call spcorr_grd_c0 (nspl1, nspl2, c0, grid)
  
		  !output spcorr_grd_c0 to file
		  sp_wght_prcp = 0.0
		  sp_ipos_prcp = 0
		  sp_jpos_prcp = 0
		  do i = 1, nspl1
...
end program generate_rndnum_c0
